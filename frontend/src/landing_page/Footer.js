      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          ...
          <div className="col">
            ...
            <br />
            <a href="" class="text-decoration-none">Referral programme</a>
            <br />
            <a href="" class="text-decoration-none">Careers</a>
            <br />
            <a href="" class="text-decoration-none">Zerodha.tech</a>
            <br />
            <a href="" class="text-decoration-none">Press & media</a>
            <br />
            <a href="" class="text-decoration-none">Zerodha cares (CSR)</a>
            <br />
          </div>
          ...
          <div className="col">
            ...
            <br />
            <a href="" class="text-decoration-none">Fund transfer</a>
            <br />
            <a href="" class="text-decoration-none">60 day challenge</a>
            <br />
          </div>
        </div>
